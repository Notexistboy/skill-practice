...
这些浮点数的类型是number。 除了支持十进制和十六进制字面量，
TypeScript还支持ECMAScript2015中引入的二进制和八进制字面量。 */
var decLiteral = 6;
...
var Color1;
(function (Color1) {
    Color1[Color1["Red1"] = 1] = "Red1";
    Color1[Color1["Green1"] = 2] = "Green1";
    Color1[Color1["Blue1"] = 3] = "Blue1";
})(Color1 || (Color1 = {}));
var d = Color1.Green1;
//或者，全部都采用手动赋值：
var Color2;
(function (Color2) {
    Color2[Color2["Red2"] = 1] = "Red2";
    Color2[Color2["Green2"] = 2] = "Green2";
    Color2[Color2["Blue3"] = 4] = "Blue3";
})(Color2 || (Color2 = {}));
var e = Color2.Green2;
...
var Color3;
(function (Color3) {
    Color3[Color3["Red3"] = 1] = "Red3";
    Color3[Color3["Green3"] = 2] = "Green3";
    Color3[Color3["Blue3"] = 3] = "Blue3";
})(Color3 || (Color3 = {}));
...
//关于let
/* 可能已经注意到了，我们使用let关键字来代替大家所熟悉的JavaScript关键字var。
let关键字是JavaScript的一个新概念，TypeScript实现了它。
我们会在以后详细介绍它，很多常见的问题都可以通过使用let来解决，
所以尽可能地使用let来代替var吧。 */
